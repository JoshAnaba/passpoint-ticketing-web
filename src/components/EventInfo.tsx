...
import { useCurrency, usePrices } from "@/context";
            ...
            <SelectContent>
              {loading ? (
                ...
                currencies.map((currencyOption) => (
                  <SelectItem key={currencyOption.currency} value={currencyOption.currency}>
        ...
        <div className="flex flex-col lg:items-end justify-between">
          <div className="text-3xl font-semibold text-foreground">
            {loading ? (
              ...
              formatCurrency(prices.standard, selectedCurrency)
            ) : (
              "Loading..."
            )}
          </div>
